    ...
    >
      <div className="space-y-6">
        ...
        >
          ...
          <div className="w-full h-32 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg mb-8 flex items-center justify-center">
            <span className="text-white text-xl font-semibold">Admin Dashboard Banner</span>
          </div>
